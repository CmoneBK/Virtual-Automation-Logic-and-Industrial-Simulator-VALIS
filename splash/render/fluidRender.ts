...
export class FluidRenderer {
    ...
    constructor(
        ...
        const blurFilterSize = 35   // larger kernel fills inter-particle gaps (air pockets) at 2× world scale
    ...
    ) 
    {
            ...
            colorAttachments: [
                {
                    ...
                    clearValue: { r: 0.0, g: 0.0, b: 0.0, a: 0.0 },  // transparent (no opaque env bg)
                    loadOp: 'clear',
                    storeOp: 'store',
                },
            ],
            ...
            colorAttachments: [
                {
                    ...
                    clearValue: { r: 0.0, g: 0.0, b: 0.0, a: 0.0 },  // transparent canvas surface
                    loadOp: 'clear',
                    storeOp: 'store',
                },
            ],
        ...
        if (!sphereRenderFl) {
            ...
            // bgColor pass — renders environment cubemap to tmpOutputTexture for fluid refraction
            // (non-fluid pixels still output alpha=0 in fluid.wgsl, so the factory shows through)
